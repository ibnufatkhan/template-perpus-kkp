...
if (isset($_POST['counter'])) {
  ...
  */
  ...
  if ($counter === true) {
    echo $member_name . __(', terimakasih sudah berkunjung ke Perpustakaan Kementerian Kelautan dan Perikanan, silahkan letakan tas anda diloker dan jika ada pertanyaan silahkan ke Pustakawan');
    if ($expire) {
